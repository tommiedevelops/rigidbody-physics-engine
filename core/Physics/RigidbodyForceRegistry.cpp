...
{
	void RigidbodyForceRegistry::Register(RigidbodyComponent* rb, ForceGenerator* fg)
	{
	...
	void RigidbodyForceRegistry::Deregister(RigidbodyComponent* rb, ForceGenerator* fg)
	{
		if (!rb || !fg) throw std::logic_error("Null rigidbody or force provided");
